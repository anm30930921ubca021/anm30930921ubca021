...
<body>
    <header>
        <div class="header-content">
            ...
            <img src="./navina.jpg" alt="Your Profile Picture" class="profile-picture">
            <h1>NAVINA  R</h1>
    ...
    <section id="education">
        <div class="section-content">
            <h2>Education</h2>
            <p>Jawaharlal nehru collegeforwomen- ComputerApplication</p>
            <h2>Education</h2>
            <p>Jawaharlal Nehru - Bachelor of Computer Application </p>
        </div>
    </section>
